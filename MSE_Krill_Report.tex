...
Krill biological parameters were derived from the fitted SS3 assessment model for the WAP (Figure \ref{fig:bio}). The maximum biological age was set to \(a_{max} = 8\) years, consistent with observed krill longevity in the WAP (\protect\hyperlink{ref-Thanassekos2014}{Thanassekos et al., 2014}). Growth follows the Von Bertalanffy equation:
